...
const likeUnlikePosts = () => {
    const likeUnlikePosts = [...document.getElementsByClassName('line-unlike-forms')]
    likeUnlikePosts.forEach(form => form.addEventListener('submit', e => {
        e.preventDefault()
                    ...
                    <div class="card-body">
                     ...
                     <div class="card-footer">
                        <div class="row">
                           ...
                           <div class="col-2">
                           <form class="line-unlike-forms" data-form-id="${el.id}">
                    ...
                    <div class="card-body">
                     ...
                     <div class="card-footer">
                        <div class="row">
                           ...
                           <div class="col-2">
                           <form class="line-unlike-forms" data-form-id="${response.id}">
